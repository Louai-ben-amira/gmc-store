...
import { ShoppingBag, Package, Wallet, LifeBuoy, User, LogOut, Shield, Zap, ClipboardList } from 'lucide-react'
...
const navItems = [
  ...
  { to: '/preorders', icon: ClipboardList, label: 'Pre-Orders', auth: true },
