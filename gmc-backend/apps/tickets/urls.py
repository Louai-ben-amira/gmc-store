...
urlpatterns = [
    ...
    path('order/<int:pk>/delete/',    views.order_ticket_delete,                  name='order_ticket_delete'),
    ...
    path('support/<int:pk>/delete/',   views.support_ticket_delete,                 name='support_ticket_delete'),
]
