        ...
        'children': [
            ...
            },
            {
                ...
                'children': [
                    ...
                    {'name': 'Mobile Legends Diamonds',     'slug': 'mobile-legends-diamonds', 'icon': '👑', 'order': 6},
                    {'name': 'Brawl Stars Gems',            'slug': 'brawl-stars-gems',        'icon': '💠', 'order': 7},
                    {'name': 'Clash of Clans Gems',         'slug': 'clash-of-clans-gems',     'icon': '⚔️', 'order': 8},
                    {'name': 'Clash Royale Gems',           'slug': 'clash-royale-gems',       'icon': '👑', 'order': 9},
                ],
            },
            {
